module CookbookApp {
    export class Renderer {
        ...
        constructor(public recipeCategoriesSummary:RecipeCategories<RecipeInterfaces.IRecipeCategorySummary>) {
        ...
        renderCategories(recipeCategoriesSummary:RecipeCategories<RecipeInterfaces.IRecipeCategorySummary>) {
